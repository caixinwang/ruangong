...
public class BusinessViewImpl implements BusinessView{
	...
	public void listBusinessAll() {
		...
		System.out.println("酒店编号\t酒店名称\t酒店地址\t酒店介绍\t起订时间\t押金");
		for(Business b : list) {
	...
	public void listBusiness() {
		...
		String inputStr = "";
		System.out.println("是否需要输入酒店名称关键词(y/n)：");
		inputStr = input.next();
		if(inputStr.equals("y")) {
			System.out.println("请输入酒店名称关键词：");
			businessName = input.next();
		}
		
		System.out.println("是否需要输入酒店地址关键词(y/n)：");
		inputStr = input.next();
		if(inputStr.equals("y")) {
			System.out.println("请输入酒店地址关键词：");
			businessAddress = input.next();
		}
		
		BusinessDao dao = new BusinessDaoImpl();
		List<Business> list = dao.listBusiness(businessName, businessAddress);
		System.out.println("酒店编号\t酒店名称\t酒店地址\t酒店介绍\t起送费\t配送费");
		for(Business b : list) {
			System.out.println(b.getBusinessId()+"\t"+b.getBusinessName()+"\t"+b.getBusinessAddress()+"\t"+b.getBusinessExplain()+"\t"+b.getStarPrice()+"\t"+b.getDeliveryPrice());
		}
	}
	...
	public void saveBusiness() {
		...
		if(businessId>0) {
			System.out.println("新建酒店成功！酒店编号为："+businessId);
		}else {
			System.out.println("新建酒店失败！");
		}
	}
	...
	public void editBusiness(Integer businessId) {
		//先将酒店信息查询出来显示，然后用户才能更新
		BusinessDao dao = new BusinessDaoImpl();
		Business business = dao.getBusinessById(businessId);
		System.out.println(business);
		
		String inputStr = "";
		System.out.println("是否修改酒店名称(y/n)：");
		inputStr = input.next();
		if(inputStr.equals("y")) {
			System.out.println("请输入新的酒店名称：");
			business.setBusinessName(input.next());
		}
		
		System.out.println("是否修改酒店地址(y/n)：");
		inputStr = input.next();
		if(inputStr.equals("y")) {
			System.out.println("请输入新的酒店地址：");
			business.setBusinessAddress(input.next());
		}
		
		System.out.println("是否修改酒店介绍(y/n)：");
		inputStr = input.next();
		if(inputStr.equals("y")) {
			System.out.println("请输入新的酒店介绍：");
